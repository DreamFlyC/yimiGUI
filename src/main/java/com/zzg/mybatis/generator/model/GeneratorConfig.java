...
public class GeneratorConfig {
	...
	private String webPackageTargetFolder;
	...
	public String getWebPackageTargetFolder() {
		return webPackageTargetFolder;
	}

	public void setWebPackageTargetFolder(String webPackageTargetFolder) {
		this.webPackageTargetFolder = webPackageTargetFolder;
	}
